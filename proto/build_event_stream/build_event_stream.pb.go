...
func (x *BuildStarted) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
func (x *BuildStarted) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
type BuildMetrics_PackageMetrics struct {
	...
	PackageLoadMetrics []*package_load_metrics.PackageLoadMetrics `protobuf:"bytes,2,rep,name=package_load_metrics,json=packageLoadMetrics,proto3" json:"package_load_metrics,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *BuildMetrics_PackageMetrics) GetPackageLoadMetrics() []*package_load_metrics.PackageLoadMetrics {
	if x != nil {
...
const file_proto_build_event_stream_proto_rawDesc = "" +
	...
	"\n" +
	"server_pid\x18\b \x01(\x03R\tserverPid\x12\x12\n" +
	"\x04host\x18\n" +
	" \x01(\tR\x04host\x12\x12\n" +
	"\x04user\x18\v \x01(\tR\x04user\"9\n" +
...
var file_proto_build_event_stream_proto_goTypes = []any{
	...
	(*package_load_metrics.PackageLoadMetrics)(nil),             // 116: devtools.build.lib.packages.metrics.PackageLoadMetrics
...
var file_proto_build_event_stream_proto_depIdxs = []int32{
	...
	113, // 150: build_event_stream.BuildMetrics.TimingMetrics.critical_path_time:type_name -> google.protobuf.Duration
	100, // 151: build_event_stream.BuildMetrics.ArtifactMetrics.source_artifacts_read:type_name -> build_event_stream.BuildMetrics.ArtifactMetrics.FilesMetric
	100, // 152: build_event_stream.BuildMetrics.ArtifactMetrics.output_artifacts_seen:type_name -> build_event_stream.BuildMetrics.ArtifactMetrics.FilesMetric
	100, // 153: build_event_stream.BuildMetrics.ArtifactMetrics.output_artifacts_from_action_cache:type_name -> build_event_stream.BuildMetrics.ArtifactMetrics.FilesMetric
	100, // 154: build_event_stream.BuildMetrics.ArtifactMetrics.top_level_artifacts:type_name -> build_event_stream.BuildMetrics.ArtifactMetrics.FilesMetric
	90,  // 155: build_event_stream.BuildMetrics.BuildGraphMetrics.dirtied_values:type_name -> build_event_stream.BuildMetrics.EvaluationStat
	90,  // 156: build_event_stream.BuildMetrics.BuildGraphMetrics.changed_values:type_name -> build_event_stream.BuildMetrics.EvaluationStat
	90,  // 157: build_event_stream.BuildMetrics.BuildGraphMetrics.built_values:type_name -> build_event_stream.BuildMetrics.EvaluationStat
	90,  // 158: build_event_stream.BuildMetrics.BuildGraphMetrics.cleaned_values:type_name -> build_event_stream.BuildMetrics.EvaluationStat
	90,  // 159: build_event_stream.BuildMetrics.BuildGraphMetrics.evaluated_values:type_name -> build_event_stream.BuildMetrics.EvaluationStat
	101, // 160: build_event_stream.BuildMetrics.BuildGraphMetrics.rule_class:type_name -> build_event_stream.BuildMetrics.BuildGraphMetrics.RuleClassCount
	102, // 161: build_event_stream.BuildMetrics.BuildGraphMetrics.aspect:type_name -> build_event_stream.BuildMetrics.BuildGraphMetrics.AspectCount
	4,   // 162: build_event_stream.BuildMetrics.WorkerMetrics.worker_status:type_name -> build_event_stream.BuildMetrics.WorkerMetrics.WorkerStatus
	117, // 163: build_event_stream.BuildMetrics.WorkerMetrics.code:type_name -> failure_details.Worker.Code
	103, // 164: build_event_stream.BuildMetrics.WorkerMetrics.worker_stats:type_name -> build_event_stream.BuildMetrics.WorkerMetrics.WorkerStats
	104, // 165: build_event_stream.BuildMetrics.NetworkMetrics.system_network_stats:type_name -> build_event_stream.BuildMetrics.NetworkMetrics.SystemNetworkStats
	105, // 166: build_event_stream.BuildMetrics.WorkerPoolMetrics.worker_pool_stats:type_name -> build_event_stream.BuildMetrics.WorkerPoolMetrics.WorkerPoolStats
	106, // 167: build_event_stream.BuildMetrics.DynamicExecutionMetrics.race_statistics:type_name -> build_event_stream.BuildMetrics.DynamicExecutionMetrics.RaceStatistics
	113, // 168: build_event_stream.BuildMetrics.ActionSummary.ActionData.system_time:type_name -> google.protobuf.Duration
	113, // 169: build_event_stream.BuildMetrics.ActionSummary.ActionData.user_time:type_name -> google.protobuf.Duration
